...
public class OI {
    ...
    public JoystickButton GotoStartupButton;
...
*/
    ...
    public OI() {
        ...
        */
        ...
        StartButton.whenPressed(new ResetEncoders());
        ...
        GotoStartupButton = new JoystickButton(mainJoy,11);
        GotoStartupButton.whenPressed(new GotoStartPosition());
