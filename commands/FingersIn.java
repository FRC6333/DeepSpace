...
/**
 * This command closes the fingers while the button is pressed
 * Note this is only used for debug mode
 */
public class FingersIn extends Command {
    ...
    protected boolean isFinished() {
        if(!Robot.operatorInterface.FingerInButton.get()){
            return true;
        } 
