...
public class Wrist extends PIDSubsystem {
    ...
    private boolean Wrist_PID_Running;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public Wrist() {

        super("wrist", 0.0001, 0.00001, 0.0);
        ...
        wristEncoder = new Encoder(17,18, false, EncodingType.k1X);
    ...
    public void stopWrist(){
        ...
        if ((Robot.shoulder_sub.getShoulderEncoderCount() < -800) && (this.wristEncoder.get() > 120000 )) {
            wrist_motor.set(0);
        } else if (this.wristEncoder.get() > 10000) {
            wrist_motor.set(-0.075); //to overcome the effects of gravity
        } else wrist_motor.set(0);
    }
